...
public:
    ...
    void setupUi(QWidget *GraphEditorSecWindow)
    {
        ...
        GraphEditorSecWindow->resize(1536, 800);
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 1486, 466));
...
""));
        ...
        horizontalSpacer_2 = new QSpacerItem(539, 14, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
...
""));
        ...
        layoutWidget->setGeometry(QRect(1290, 70, 153, 52));
